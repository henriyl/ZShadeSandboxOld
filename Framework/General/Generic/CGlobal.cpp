...
GameDirectory2D* CGlobal::LoadGameDirectory2D(string game_folder)
{
	...
	string xml_menu_folder = gameDirectory->GAME_FOLDER; xml_menu_folder.append("\\XML\\Menu");
	gameDirectory->m_xml_menu_path = xml_menu_folder;

	string xml_hud_folder = gameDirectory->GAME_FOLDER; xml_hud_folder.append("\\XML\\HUD");
