...
void ZShadeINIWriter::WriteInt(std::string p_SectionName, int ivalue)
{
	char szValue[255];
...
void ZShadeINIWriter::WriteFloat(std::string p_SectionName, float fvalue)
{
	char szValue[255];
...
void ZShadeINIWriter::WriteBoolean(std::string p_SectionName, bool bvalue)
{
	char szValue[255];
...
void ZShadeINIWriter::WriteString(std::string p_SectionName, std::string svalue)
{
