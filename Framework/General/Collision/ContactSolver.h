...
public:
	...
	void Solve(PhysicsBody* body1, PhysicsBody* body2, ContactManifold* manifold);
	...
	void CalculateContactPoints(PhysicsBody* body1, PhysicsBody* body2, GJK_MTV* mtv, ContactManifold* manifold);
};
//==================================================================================================================================
//==================================================================================================================================
