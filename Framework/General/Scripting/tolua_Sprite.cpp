...
static int tolua_isStatic_Sprite(lua_State* L)
{
	...
	if (self != 0)
	{
		tolua_push_bool(L, self->IsStatic());
	}
...
//==================================================================================================================================
#ifndef TOLUA_DISABLE_tolua_setCoin_Sprite
static int tolua_setCoin_Sprite(lua_State* L)
{
	AISprite* self = tolua_Sprite_Safe_number(L, "setCoin");
	
	if (self != 0)
	{
		self->Coin() = tolua_get_int(L, 2);
	}
	
	return 0;
}
#endif //TOLUA_DISABLE_tolua_setCoin_Sprite
//==================================================================================================================================
#ifndef TOLUA_DISABLE_tolua_getCoin_Sprite
static int tolua_getCoin_Sprite(lua_State* L)
{
	AISprite* self = tolua_Sprite_Safe(L, "setCoin");
	
	if (self != 0)
	{
		tolua_push_int(L, self->Coin());
	}
	
	return 1;
}
#endif //TOLUA_DISABLE_tolua_getCoin_Sprite
//==================================================================================================================================
...
static int tolua_setDamageAmount_Sprite(lua_State* L)
{
	...
	if (self != 0)
	{
		self->DamageAmount() = tolua_get_int(L, 2);
	}
...
static int tolua_getDamageAmount_Sprite(lua_State* L)
{
	...
	if (self != 0)
	{
		tolua_push_bool(L, self->DamageAmount());
	}
...
TOLUA_API int tolua_Sprite_open()
{
	...
	if (L != NULL)
	{
		...
		tolua_function(L, "set_coin", tolua_setCoin_Sprite);
		tolua_function(L, "get_coin", tolua_getCoin_Sprite);
