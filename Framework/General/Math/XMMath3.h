...
public:
	...
	void Cross(XMMath3 val);
	void Cross(XMMath3 val1, XMMath3 val2);

	void Cross(XMFLOAT3 val);
	void Cross(XMFLOAT3 val1, XMFLOAT3 val2);
	void Cross(XMVECTOR val1, XMVECTOR val2);
