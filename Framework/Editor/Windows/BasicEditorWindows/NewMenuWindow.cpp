...
//================================================================================================================
NewMenuWindow::NewMenuWindow(MenuEditorSystem* menuEditorSystem, HINSTANCE hInstance, D3D* d3d)
:   m_running(false)
,   m_created(false)
,   m_escape(false)
,   m_windowWidth(450)
...
,   m_menuType(ZShadeSandboxEnvironment::EMenuType::eMainMenu)
,   m_D3DSystem(d3d)
{
	m_Window = new Window();
	
	if (!m_Window->Init(hInstance, false, m_windowWidth, m_windowHeight, "New Menu Window", "NewMenuWindow", NULL))
	{
		ZShadeMessageCenter::MsgBoxError(NULL, "NewMenuWindow Creation Failed");
	}
	
	m_Window->SetUserMessageFunction(WM_COMMAND, bind(mem_fn(&NewMenuWindow::Command), this, _1, _2, _3, _4));
	m_Window->SetUserMessageFunction(WM_PAINT, bind(mem_fn(&NewMenuWindow::Paint), this, _1, _2, _3, _4));
...
#pragma region "GUI"
	...
	m_menuNameText.Init(m_Window->GetHwnd(), "Menu Name", x, y, textWidth, 16, MENU_NAME_TEXT);
	...
	y += 50;
	m_menuSizeText.Init(m_Window->GetHwnd(), "Menu Size", x, y, textWidth, 16, MENU_SIZE_TEXT);
	m_menuSizeContainer.Init(m_Window->GetHwnd(), x, y + 17, radioWidth, radioHeight, MENU_SIZE_RADIO_CONTAINER);
	m_menuSizeContainer.AddRadioButton(m_Window->GetHwnd(), true, "800x600", x, y + 17, radioButtonWidth, radioHeight, MENU_SIZE_RADIO_800X600);
	m_menuSizeContainer.AddRadioButton(m_Window->GetHwnd(), false, "1024x768", x + 100, y + 17, radioButtonWidth, radioHeight, MENU_SIZE_RADIO_1024X768);
	m_menuSizeContainer.AddRadioButton(m_Window->GetHwnd(), false, "1366x768", x + 200, y + 17, radioButtonWidth, radioHeight, MENU_SIZE_RADIO_1366X768);
	m_menuSizeContainer.AddRadioButton(m_Window->GetHwnd(), false, "1280x1024", x, y + 17 + radioHeight, radioButtonWidth, radioHeight, MENU_SIZE_RADIO_1280X1024);
	m_menuSizeContainer.AddRadioButton(m_Window->GetHwnd(), false, "1920x1080", x + 100, y + 17 + radioHeight, radioButtonWidth * 2, radioHeight, MENU_SIZE_RADIO_1920X1080);
	...
	y += 80;
	m_menuTypeText.Init(m_Window->GetHwnd(), "Menu Type", x, y, textWidth, 16, MENU_TYPE_TEXT);
	...
	m_createButton.Init(m_Window->GetHwnd(), "Create", 295, 160, 60, 30, CREATE_BUTTON);
	m_closeButton.Init(m_Window->GetHwnd(), "Close", 360, 160, 60, 30, CLOSE_BUTTON);
#pragma endregion
}
//================================================================================================================
NewMenuWindow::NewMenuWindow(const NewMenuWindow& other)
{
}
//================================================================================================================
...
//================================================================================================================
void NewMenuWindow::SetPosition(int x, int y)
{
	m_Window->SetWindowPos(x, y);
}
//================================================================================================================
void NewMenuWindow::Invalidate()
{
	m_Window->Invalidate();
}
//================================================================================================================
...
*/
//================================================================================================================
void NewMenuWindow::SetGD(GameDirectory2D* gd)
{
	this->gd = gd;
}
//================================================================================================================
void NewMenuWindow::AddMenuEditorSystem(MenuEditorSystem* menuEditorSystem)
{
	m_MenuEditorSystem = menuEditorSystem;
}
//================================================================================================================
...
//================================================================================================================
LRESULT NewMenuWindow::Command(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (LOWORD(wParam))
	{
		...
		break;
		case MENU_SIZE_RADIO_800X600:
		{
			m_menuWidth = 800;
			m_menuHeight = 600;
		}
		break;
		case MENU_SIZE_RADIO_1024X768:
		{
			m_menuWidth = 1024;
			m_menuHeight = 768;
		}
		break;
		case MENU_SIZE_RADIO_1366X768:
		{
			m_menuWidth = 1366;
			m_menuHeight = 768;
		}
		break;
		case MENU_SIZE_RADIO_1280X1024:
		{
			m_menuWidth = 1280;
			m_menuHeight = 1024;
		}
		break;
		case MENU_SIZE_RADIO_1920X1080:
		{
			m_menuWidth = 1920;
			m_menuHeight = 1080;
		}
		break;
		case MENU_TYPE_RADIO_MAINMENU:
		{
			m_menuType = ZShadeSandboxEnvironment::EMenuType::eMainMenu;
		}
		break;
		case MENU_TYPE_RADIO_INGAMEMENU:
		{
			m_menuType = ZShadeSandboxEnvironment::EMenuType::eInGameMenu;
		}
		break;
	}
...
//================================================================================================================
LRESULT NewMenuWindow::Paint(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
//--------------------------------------------------------------------------------------------------------------------
void NewMenuWindow::Show(bool show)
{
	m_Window->Show(show);
