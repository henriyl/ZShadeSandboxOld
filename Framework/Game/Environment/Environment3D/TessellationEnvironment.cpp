...
//===============================================================================================================================
//===============================================================================================================================
TessellationEnvironment::TessellationEnvironment(LPCSTR base_window_name, LPCSTR render_window_name, EngineOptions* eo, bool init_lua)
...
,   fTessFactor(6.0f)
{
	...
	mTessellatedQuad = new ZShadeSandboxMesh::QuadMesh(m_D3DSystem, mp, false);
	...
	mRegularQuad = new ZShadeSandboxMesh::QuadMesh(m_D3DSystem, mp, false);
}
//===============================================================================================================================
