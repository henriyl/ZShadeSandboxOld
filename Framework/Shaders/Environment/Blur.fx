...
technique11 HorizontalBlurTech
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_5_0, HorizontalBlurVS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, HorizontalBlurPS() ) );
	}
}

technique11 VerticalBlurTech
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_5_0, VerticalBlurVS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_5_0, VerticalBlurPS() ) );
	}
}