...
bool ZShadeSandboxMesh::VertexNormalTexBlend::operator == (const ZShadeSandboxMesh::VertexNormalTexBlend& rhs) const
{
	...
	bool result1 = ZMath::CompareVector3WithEpsilon(position, rhs.position);
	bool result2 = ZMath::CompareVector3WithEpsilon(normal, rhs.normal);
	bool result3 = ZMath::CompareVector2WithEpsilon(texture, rhs.texture);
