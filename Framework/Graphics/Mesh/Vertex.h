...
struct VertexLayout
{
	...
	static D3D11_INPUT_ELEMENT_DESC mesh_layout_pos_color_boundsy[3];
	static D3D11_INPUT_ELEMENT_DESC mesh_layout_pos_tex_boundsy[3];
