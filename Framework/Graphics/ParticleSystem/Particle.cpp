...
void Particle::CreateMesh()
{
	...
	//mp.textureName = m_textureName;
	//mp.texturePath = m_texturePath;
	mp.material = MaterialManager::Instance()->GetMaterial(m_textureName);
	mp.in2D = m_in2D;
	//mp.tt = m_textureType;
	mp.textureWidth = m_size.x;
	mp.textureHeight = m_size.y;
	...
	switch (m_shape)
	{
		...
		case PS_Rectangular: m_RectangleMesh = new ZShadeSandboxMesh::QuadMesh(m_D3DSystem, mp, true); break;
	}
}
//==================================================================================================================================
