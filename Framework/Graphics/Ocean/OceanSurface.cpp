...
{
	//mHeightfieldShader = new OceanHeightfieldShader(mD3DSystem, mOceanParams);
	//mHeightfieldShader->Render(0);
	...
	//mSurfaceShader->SetTexDisplacement(TextureManager::Instance()->GetTexture("Textures\\displacement.png"));
}
//==============================================================================================================================
...
void OceanSurface::Render(Camera* camera, float seaLevel, float dt, OceanPatch* patch)
{
	...
	if (patch->isLeaf)
	{
		...
		//mSurfaceShader->SetTexDisplacement(mHeightfieldShader->DisplacementSRV());
		//mSurfaceShader->SetTexGradient(mHeightfieldShader->GradientSRV());
		mSurfaceShader->Render11(patch->mesh->indexCount, camera, iFrustumCull, XMMatrixIdentity(), *mOceanParams);
	}
	else
	{
