...
//==================================================================================================================================
void PlatformerBackground::AddBackground(string backgroundName, int width, int height, bool useParallaxScrolling, bool stayStill, int backWidth, float dx)
{
	BackgroundInfo bi;

	Sprite* spr = new Sprite(m_D3DSystem);
	//spr->Initialize(m_EngineOptions->m_GD->m_sprites_path, backgroundName, XMFLOAT3(0, 0, 0), width, height, STATIC);
	// This needs to be fixed
	spr->Initialize("C:\\Spazzy\\Sprites", backgroundName, XMFLOAT3(0, 0, 0), width, height, STATIC);
