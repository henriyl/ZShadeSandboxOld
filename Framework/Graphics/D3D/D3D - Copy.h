...
public:
	...
	bool BeginScene(bool PostProcessEnable, float red, float green, float blue, float alpha);
	void EndScene();
	...
	RenderTarget2D* GetColorRenderTarget() { return m_pColorRT; }
	DepthStencilBuffer* GetDepthStencilBuffer() { return m_pDepthStencilBuffer; }
...
private:
	...
	DepthStencilBuffer* m_pDepthStencilBuffer;
	RenderTarget2D* m_pColorRT;
	...
	//
	// Collection of render targets to create
	//

	vector< RenderTarget2D* > m_RenderTargets;
};
